(* EQ-015/P.26.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Dirac equation *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: cited lineage only) *)
(* statement (Toledo canonical, latest): Dirac equation *)
...
Definition EQ_015__P_26_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
