(* EQ-015/W.29.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.05.v1 *)
(* name: AI-rent differential D^rent *)
(* tier: Definition (definition/identity) *)
(* statement (Toledo canonical, latest): D^rent_(i,t) = (Rent^(AI,out)_(i,t) - Rent^(AI,in)_(i,t)) / Y_(i,t) *)
...
Definition EQ_015__W_29_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
