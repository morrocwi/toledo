(* EQ-015/S.22.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.02.v1 *)
(* name: Individual Ethics Condition *)
(* tier: Definition (definition (author-labelled 'final'/locked)) *)
(* statement (Toledo canonical, latest): Eth_ind(A) ⇔ d/dt' V_{A,R_A} ≤ 0 ∧ Δ_spec(R_A) > 0 *)
...
Definition EQ_015__S_22_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
