(* EQ-015/P.83.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Stefan-Boltzmann law `P=εσAT⁴` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure` (σ already registered in `CONSTANTS`)) *)
(* statement (Toledo canonical, latest): Stefan-Boltzmann law P=\varepsilon\sigmaAT^{4} *)
...
Definition EQ_015__P_83_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
