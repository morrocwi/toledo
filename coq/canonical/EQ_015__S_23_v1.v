(* EQ-015/S.23.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Spectral decomposition of M *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): M(t') = M_0 φ_0 + Σ_k a_k(t') φ_k *)
...
Definition EQ_015__S_23_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
