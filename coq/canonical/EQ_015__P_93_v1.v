(* EQ-015/P.93.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Torsion of circular shafts: shear stress `τ=Tr/J`, angle of twist `θ=TL/GJ`, polar moment of a solid/hollow circular section *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Torsion of circular shafts: shear stress \tau=Tr/J, angle of twist \theta=TL/GJ, polar moment of a solid/hollow circular section *)
...
Definition EQ_015__P_93_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
