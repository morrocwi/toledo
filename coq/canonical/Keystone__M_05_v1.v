(* Keystone/M.05.v1 -- mapped_not_wrapped -> wrapped -- restates Qadd_nonneg (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Keystone.v) -- parents: Keystone *)
...
Definition Keystone__M_05_v1_restates_Qadd_nonneg_type := ltac:(let t := type of (@Qadd_nonneg) in exact t).
Lemma Keystone__M_05_v1_restates_Qadd_nonneg : Keystone__M_05_v1_restates_Qadd_nonneg_type.
Proof. exact (@Qadd_nonneg). Qed.

Print Assumptions Keystone__M_05_v1_restates_Qadd_nonneg.
