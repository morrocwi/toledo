(* EQ-015/S.65.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.11.v1 *)
(* name: D7: recoverable gap vs accumulated loss *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): Recoverable gap ≠ accumulated loss *)
...
Definition EQ_015__S_65_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
