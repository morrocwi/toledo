(* CMC/M.14.v1 -- mapped_not_wrapped -> wrapped -- restates class_witness_blocks_refuter (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_ModelClass_Witnesses.v) -- parents: CMC *)
(* name: class_witness_blocks_refuter (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact class_witness_blocks_refuter.` against the already-verified import
...
Theorem CMC__M_14_v1_restates_class_witness_blocks_refuter : forall (c : WitnessModelClass) (g : TransportReadout),
    ClassWitness c g -> CMC_Refuter_Burden g -> False.
Proof. exact class_witness_blocks_refuter. Qed.

Print Assumptions CMC__M_14_v1_restates_class_witness_blocks_refuter.
