(* L_R/M.07.v1 -- mapped_not_wrapped -> wrapped -- restates orient_coincident_ac (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Geometry.v) -- parents: L_R *)
(* name: orient_coincident_ac (Lemma) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of orient_coincident_ac`
   ...
   is `exact orient_coincident_ac.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_Geometry.

Definition L_R__M_07_v1_restates_orient_coincident_ac_type := ltac:(let t := type of (@orient_coincident_ac) in exact t).
Lemma L_R__M_07_v1_restates_orient_coincident_ac : L_R__M_07_v1_restates_orient_coincident_ac_type.
Proof. exact (@orient_coincident_ac). Qed.

Print Assumptions L_R__M_07_v1_restates_orient_coincident_ac.
