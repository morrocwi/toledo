(* EQ-015/W.58.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.19.v1 *)
(* name: Urgency vector U_t *)
(* tier: Definition (definition (Reversibility Principle itself [Open])) *)
(* statement (Toledo canonical, latest): U_t = < U_(1,t), ..., U_(J,t) > *)
...
Definition EQ_015__W_58_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
