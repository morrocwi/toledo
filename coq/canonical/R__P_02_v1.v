(* R/P.02.v1 -- mapped_not_wrapped -> wrapped -- restates squeeze (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:case_studies/double_pendulum_readout/ShakeIrrational.v) -- parents: R *)
(* name: squeeze (Lemma) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of squeeze`
   ...
   is `exact squeeze.` against the already-verified IDM mirror
...
Definition R__P_02_v1_restates_squeeze_type := ltac:(let t := type of (@squeeze) in exact t).
Lemma R__P_02_v1_restates_squeeze : R__P_02_v1_restates_squeeze_type.
Proof. exact (@squeeze). Qed.

Print Assumptions R__P_02_v1_restates_squeeze.
