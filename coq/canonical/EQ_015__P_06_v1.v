(* EQ-015/P.06.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Regge-Wheeler equation *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: potential imported, mechanized as a coefficient field on this project's own graph-Laplacian evolution law) *)
(* statement (Toledo canonical, latest): Regge-Wheeler equation *)
...
Definition EQ_015__P_06_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
