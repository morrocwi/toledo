(* EQ-015/S.25.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Survival projection operator *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): P_{S_A(R)} : M → S_A(R) *)
...
Definition EQ_015__S_25_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
