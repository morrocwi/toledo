(* A.5/W.16.v1 -- Definition -- parents: A.5/M.01.v1, A.5/W.03.v1 *)
(* Toledo v1.1 lane B1: formalised as a typed Definition in a finite/discrete model (Q) per registry/CANONICAL.json's own statement.latex; no Coq.Reals, no Classical, no Admitted. *)
(* instantiates the already-closed joint theorem at A.5/W.12.v1 with n=5; not a new proof. *)
...
(* This bundle's own non-collapse pair is instance n=5 of the joint
...
Theorem A_5__W_16_v1_holds : CAN_160_separation 5.
