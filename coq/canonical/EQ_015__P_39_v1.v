(* EQ-015/P.39.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Causal set theory *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: position/lineage citation) *)
(* statement (Toledo canonical, latest): Causal set theory *)
...
Definition EQ_015__P_39_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
