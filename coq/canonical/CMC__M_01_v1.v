(* CMC/M.01.v1 -- mapped_not_wrapped -> wrapped -- restates decomposed_bridge_obligation (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_Bridge_Decomposition.v) -- parents: CMC *)
(* name: decomposed_bridge_obligation (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact decomposed_bridge_obligation.` against the already-verified import
...
Theorem CMC__M_01_v1_restates_decomposed_bridge_obligation : CMC_Bridge_Obligation.
Proof. exact decomposed_bridge_obligation. Qed.

Print Assumptions CMC__M_01_v1_restates_decomposed_bridge_obligation.
