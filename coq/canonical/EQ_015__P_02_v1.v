(* EQ-015/P.02.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Schrödinger equation / eigenvalue problem *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: dispersion form compared, not re-derived) *)
(* statement (Toledo canonical, latest): Schrödinger equation / eigenvalue problem *)
...
Definition EQ_015__P_02_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
