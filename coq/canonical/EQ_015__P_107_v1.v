(* EQ-015/P.107.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Oscillating electric dipole radiated power `P = p0^2 omega^4/(12 pi eps0 c^3)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Oscillating electric dipole radiated power P = p0^2 omega^4/(12 pi eps0 c^3) *)
...
Definition EQ_015__P_107_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
