(* CMC/M.09.v1 -- mapped_not_wrapped -> wrapped -- restates finite_speed_definition_not_closure_definition (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_Independent_Definitions.v) -- parents: CMC *)
(* name: finite_speed_definition_not_closure_definition (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact finite_speed_definition_not_closure_definition.` against the already-verified import
...
Theorem CMC__M_09_v1_restates_finite_speed_definition_not_closure_definition : IntrinsicFiniteSpeed_independent finite_speed_without_closure_signature /\
  ClosureFree_independent finite_speed_without_closure_signature.
Proof. exact finite_speed_definition_not_closure_definition. Qed.

Print Assumptions CMC__M_09_v1_restates_finite_speed_definition_not_closure_definition.
