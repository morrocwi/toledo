(* EQ-015/P.29.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Higgs mechanism *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: explicitly NOT engaged — cited only to mark a boundary) *)
(* statement (Toledo canonical, latest): Higgs mechanism *)
...
Definition EQ_015__P_29_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
