(* EQ-015/P.79.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Planck-Einstein photon energy relation `E=hf=hc/λ` *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Planck-Einstein photon energy relation E=hf=hc/\lambda *)
...
Definition EQ_015__P_79_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
