(* EQ-015/P.87.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Solenoid magnetic field `B=μ0nI` and straight-wire field `B=μ0I/(2πr)` (Ampère's law special cases) *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Solenoid magnetic field B=\mu0nI and straight-wire field B=\mu0I/(2\pir) (Ampère's law special cases) *)
...
Definition EQ_015__P_87_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
