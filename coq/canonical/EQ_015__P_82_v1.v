(* EQ-015/P.82.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Newton's law of cooling (convective form) `Q/t=hAΔT` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Newton's law of cooling (convective form) Q/t=hA\DeltaT *)
...
Definition EQ_015__P_82_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
