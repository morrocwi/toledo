(* EQ-015/P.85.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Linear thermal expansion `ΔL=αL0ΔT` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Linear thermal expansion \DeltaL=\alphaL0\DeltaT *)
...
Definition EQ_015__P_85_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
