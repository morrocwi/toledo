(* EQ-015/S.62.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.11.v1 *)
(* name: D4: task potential vs aggregate potential *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): Task potential ≠ aggregate potential *)
...
Definition EQ_015__S_62_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
