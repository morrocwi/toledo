(* EQ-015/S.32.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Regime incompatibility *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): Δ_spec(R_i ∪ R_j) ≤ 0 *)
...
Definition EQ_015__S_32_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
