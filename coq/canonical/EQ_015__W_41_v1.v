(* EQ-015/W.41.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/W.08.v1 *)
(* name: Conditional non-collapse: concentration/dependency/agency loss *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): concentration =/=> dependency =/=> agency loss *)
...
Definition EQ_015__W_41_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
