(* L_R/M.25.v1 -- mapped_not_wrapped -> wrapped -- restates schur_congruence_10 (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Schur.v) -- parents: L_R *)
(* name: schur_congruence_10 (Theorem) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of schur_congruence_10`
   ...
   is `exact schur_congruence_10.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_Schur.

Definition L_R__M_25_v1_restates_schur_congruence_10_type := ltac:(let t := type of (@schur_congruence_10) in exact t).
Theorem L_R__M_25_v1_restates_schur_congruence_10 : L_R__M_25_v1_restates_schur_congruence_10_type.
Proof. exact (@schur_congruence_10). Qed.

Print Assumptions L_R__M_25_v1_restates_schur_congruence_10.
