(* EQ-015/P.49.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Verlinde's entropic gravity *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: position/adjacent-work citation) *)
(* statement (Toledo canonical, latest): Verlinde's entropic gravity *)
...
Definition EQ_015__P_49_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
