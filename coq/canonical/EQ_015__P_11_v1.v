(* EQ-015/P.11.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Wilson-loop area-law criterion for confinement `−log⟨W(C)⟩ = σ·A(C)`, and the center (`Z_N`) role in confinement|K. Wilson (1974); center-symmetry / center-vortex work (’t Hooft 1978; Greensite)|1974; 1978+ *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: ²` (no QCD potential fed in). `[EXACT, Z_3/2D ONLY]` — not full SU(3) confinement in 3+1D) *)
(* statement (Toledo canonical, latest): Wilson-loop area-law criterion for confinement −log\langleW(C)\rangle = \sigma\cdotA(C), and the center (Z_N) role in confinement|K. Wilson (1974); center-symmetry / center-vortex work (’t Hooft 1978; Greensite)|1974; 1978+ *)
...
Definition EQ_015__P_11_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
