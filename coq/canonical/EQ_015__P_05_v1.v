(* EQ-015/P.05.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Schwarzschild metric *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: imported as a `Definition`, not derived) *)
(* statement (Toledo canonical, latest): Schwarzschild metric *)
...
Definition EQ_015__P_05_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
