(* R/P.01.v1 -- mapped_not_wrapped -> wrapped -- restates s_val (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:case_studies/double_pendulum_readout/ShakeIrrational.v) -- parents: R *)
(* name: s_val (Lemma) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of s_val`
   ...
   is `exact s_val.` against the already-verified IDM mirror
...
Definition R__P_01_v1_restates_s_val_type := ltac:(let t := type of (@s_val) in exact t).
Lemma R__P_01_v1_restates_s_val : R__P_01_v1_restates_s_val_type.
Proof. exact (@s_val). Qed.

Print Assumptions R__P_01_v1_restates_s_val.
