(* Z/M.20.v1 -- mapped_not_wrapped -> wrapped -- restates tadd_0_l (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Tropical.v) -- parents: Z *)
(* name: tadd_0_l (Theorem) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of tadd_0_l`
   ...
   is `exact tadd_0_l.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_Tropical.

Definition Z__M_20_v1_restates_tadd_0_l_type := ltac:(let t := type of (@tadd_0_l) in exact t).
Theorem Z__M_20_v1_restates_tadd_0_l : Z__M_20_v1_restates_tadd_0_l_type.
Proof. exact (@tadd_0_l). Qed.

Print Assumptions Z__M_20_v1_restates_tadd_0_l.
