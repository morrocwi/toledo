(* EQ-015/W.43.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/W.10.v1 *)
(* name: Growth-rate decomposition of P^H_t (part 1) *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): P_dot^H_t / P^H_t = theta_Gamma (Gamma_dot^eff_t/Gamma^eff_t) + theta_A (A_dot^corr_(H,t)/A^corr_(H,t)) + theta_R (r_dot^H_t/r^H_t) + theta_Lambda (Lambda_dot^live_(H,t)/Lambda^live_(H,t)) *)
...
Definition EQ_015__W_43_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
