(* EQ-015/W.38.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/W.08.v1 *)
(* name: Credible-exit index X *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): X_(i,t)(e; j) = clip( V_(i,t)(e | -j) / V_(i,t)(e), 0, 1 ) *)
...
Definition EQ_015__W_38_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
