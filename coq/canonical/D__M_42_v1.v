(* D/M.42.v1 -- mapped_not_wrapped -> wrapped -- restates no_infinite_readout (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_FiniteWitnesses2.v) -- parents: D *)
(* name: no_infinite_readout (Theorem) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of no_infinite_readout`
   ...
   is `exact no_infinite_readout.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_FiniteWitnesses2.

Definition D__M_42_v1_restates_no_infinite_readout_type := ltac:(let t := type of (@no_infinite_readout) in exact t).
Theorem D__M_42_v1_restates_no_infinite_readout : D__M_42_v1_restates_no_infinite_readout_type.
Proof. exact (@no_infinite_readout). Qed.

Print Assumptions D__M_42_v1_restates_no_infinite_readout.
