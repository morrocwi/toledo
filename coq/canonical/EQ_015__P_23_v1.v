(* EQ-015/P.23.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Quasinormal mode spectrum (continued-fraction method) *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: literature target value cited for comparison, not re-derived) *)
(* statement (Toledo canonical, latest): Quasinormal mode spectrum (continued-fraction method) *)
...
Definition EQ_015__P_23_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
