(* EQ-015/P.20.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Quasinormal-mode late-time power-law ("Price") tail *)
(* tier: finite_diagnostic (finite_diagnostic -- use_text: cited target phenomenon; time-domain evolution + exponent measurement is this project's own `finite_diagnostic` script, not a re-derivation of Price's analytic argument) *)
(* statement (Toledo canonical, latest): Quasinormal-mode late-time power-law ("Price") tail *)
...
Definition EQ_015__P_20_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
