(* EQ-015/S.21.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.02.v1 *)
(* name: Notation: positive-part derivative *)
(* tier: Definition (definition (author-labelled 'final'/locked)) *)
(* statement (Toledo canonical, latest): V̇⁺ := max(dV/dt', 0) *)
...
Definition EQ_015__S_21_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
