(* EQ-015/P.73.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Snell's law of refraction `n1 sin θ1 = n2 sin θ2` and total-internal-reflection critical angle *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Snell's law of refraction n1 sin \theta1 = n2 sin \theta2 and total-internal-reflection critical angle *)
...
Definition EQ_015__P_73_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
