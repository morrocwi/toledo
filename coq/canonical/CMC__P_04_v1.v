(* CMC/P.04.v1 -- mapped_not_wrapped -> wrapped -- restates certified_physical_readout_has_nonzero_closure (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_PhysicsClass_Instances.v) -- parents: CMC *)
(* name: certified_physical_readout_has_nonzero_closure (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact certified_physical_readout_has_nonzero_closure.` against the already-verified import
...
Theorem CMC__P_04_v1_restates_certified_physical_readout_has_nonzero_closure : forall r : CertifiedPhysicalReadout,
    NonzeroClosure (certified_gamma r).
Proof. exact certified_physical_readout_has_nonzero_closure. Qed.

Print Assumptions CMC__P_04_v1_restates_certified_physical_readout_has_nonzero_closure.
