(* EQ-015/P.80.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Mass-energy equivalence `E=mc²` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Mass-energy equivalence E=mc^{2} *)
...
Definition EQ_015__P_80_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
