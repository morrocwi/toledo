(* EQ-015/P.27.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Zitterbewegung (relativistic) *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: cited lineage only) *)
(* statement (Toledo canonical, latest): Zitterbewegung (relativistic) *)
...
Definition EQ_015__P_27_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
