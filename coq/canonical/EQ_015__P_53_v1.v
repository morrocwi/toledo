(* EQ-015/P.53.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Ryu–Takayanagi entanglement=area *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: position/lineage citation) *)
(* statement (Toledo canonical, latest): Ryu–Takayanagi entanglement=area *)
...
Definition EQ_015__P_53_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
