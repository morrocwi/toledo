(* EQ-015/S.27.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Individual non-survival (lim=0) *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): lim_{n→∞} ‖P_{S_A(R_A)} M(t'+n)‖² = 0 *)
...
Definition EQ_015__S_27_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
