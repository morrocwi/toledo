(* R/M.16.v1 -- mapped_not_wrapped -> wrapped -- restates q01 (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Certified.v) -- parents: R *)
(* name: q01 (Lemma) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of q01`
   ...
   is `exact q01.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_Certified.

Definition R__M_16_v1_restates_q01_type := ltac:(let t := type of (@q01) in exact t).
Lemma R__M_16_v1_restates_q01 : R__M_16_v1_restates_q01_type.
Proof. exact (@q01). Qed.

Print Assumptions R__M_16_v1_restates_q01.
