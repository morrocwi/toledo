(* EQ-015/P.89.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Coulomb's law potential of a point charge `V=kq/r`, uniform-field relation `E=V/d`, and capacitor relations (`Q=CV`, `C=ε0A/d`, `E=½CV²`, series/parallel capacitance) *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Coulomb's law potential of a point charge V=kq/r, uniform-field relation E=V/d, and capacitor relations (Q=CV, C=\varepsilon0A/d, E=\tfrac{1}{2}CV^{2}, series/parallel capacitance) *)
...
Definition EQ_015__P_89_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
