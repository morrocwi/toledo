(* EQ-015/P.114.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Resonance quality factor from damping ratio `Q = 1/(2 zeta)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Resonance quality factor from damping ratio Q = 1/(2 zeta) *)
...
Definition EQ_015__P_114_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
