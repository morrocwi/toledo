(* A2/M.26.v1 -- mapped_not_wrapped -> wrapped -- restates weak_duality_2 (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Reduction.v) -- parents: A2 *)
(* name: weak_duality_2 (Theorem) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of weak_duality_2`
   ...
   is `exact weak_duality_2.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_Reduction.

Definition A2__M_26_v1_restates_weak_duality_2_type := ltac:(let t := type of (@weak_duality_2) in exact t).
Theorem A2__M_26_v1_restates_weak_duality_2 : A2__M_26_v1_restates_weak_duality_2_type.
Proof. exact (@weak_duality_2). Qed.

Print Assumptions A2__M_26_v1_restates_weak_duality_2.
