(* EQ-015/P.90.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Real-source terminal voltage with internal resistance `V=ε-Ir` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Real-source terminal voltage with internal resistance V=\varepsilon-Ir *)
...
Definition EQ_015__P_90_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
