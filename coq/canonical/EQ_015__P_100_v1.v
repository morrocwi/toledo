(* EQ-015/P.100.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Normal Zeeman effect `dE = m_l mu_B B` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Normal Zeeman effect dE = m_l mu_B B *)
...
Definition EQ_015__P_100_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
