(* EQ-015/P.86.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Force on a current-carrying wire `F=BIL` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Force on a current-carrying wire F=BIL *)
...
Definition EQ_015__P_86_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
