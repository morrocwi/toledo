(* EQ-015/P.21.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Late-time tail dependence on initial data *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: cited as the reason two initial-data families were tested separately; not re-derived) *)
(* statement (Toledo canonical, latest): Late-time tail dependence on initial data *)
...
Definition EQ_015__P_21_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
