(* EQ-015/P.32.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Robb's causal-order axiomatization *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: position/lineage citation) *)
(* statement (Toledo canonical, latest): Robb's causal-order axiomatization *)
...
Definition EQ_015__P_32_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
