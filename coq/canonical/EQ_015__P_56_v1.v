(* EQ-015/P.56.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: QNM review (literature target values) *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: literature target value, comparison only) *)
(* statement (Toledo canonical, latest): QNM review (literature target values) *)
...
Definition EQ_015__P_56_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
