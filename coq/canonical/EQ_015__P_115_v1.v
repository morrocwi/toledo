(* EQ-015/P.115.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Ziegler-Nichols closed-loop PID tuning rule (`Kp=0.6 K_u`, `Ti=0.5 P_u`, `Td=0.125 P_u`) *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Ziegler-Nichols closed-loop PID tuning rule (Kp=0.6 K_u, Ti=0.5 P_u, Td=0.125 P_u) *)
...
Definition EQ_015__P_115_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
