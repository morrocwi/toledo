(* EQ-015/P.01.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Planck–Einstein relation `E=ħω` *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: imported constant relation, cited) *)
(* statement (Toledo canonical, latest): Planck–Einstein relation E=\hbar\omega *)
...
Definition EQ_015__P_01_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
