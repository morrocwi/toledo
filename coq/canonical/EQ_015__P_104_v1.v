(* EQ-015/P.104.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Quantum harmonic oscillator canonical partition function `Z = 1/(2 sinh(hbar omega/2 k_B T))` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Quantum harmonic oscillator canonical partition function Z = 1/(2 sinh(hbar omega/2 k_B T)) *)
...
Definition EQ_015__P_104_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
