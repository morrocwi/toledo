(* EQ-015/S.54.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.06.v1 *)
(* name: Aggregate corrigible-agency A^corr_A *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): A^corr_A(h,z;T,B,P,w) := Σ_g w_g p*_{A,g} ∈ [0,1] *)
...
Definition EQ_015__S_54_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
