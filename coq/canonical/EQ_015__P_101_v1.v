(* EQ-015/P.101.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Rutherford differential scattering cross section `dsigma/dOmega = (Z1 Z2 k_e e^2/4E)^2 / sin^4(theta/2)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Rutherford differential scattering cross section dsigma/dOmega = (Z1 Z2 k_e e^2/4E)^2 / sin^4(theta/2) *)
...
Definition EQ_015__P_101_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
