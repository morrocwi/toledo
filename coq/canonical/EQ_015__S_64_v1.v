(* EQ-015/S.64.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.11.v1 *)
(* name: D6: diagnosis vs attribution of responsibility *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): Diagnosis of compression ≠ attribution of responsibility *)
...
Definition EQ_015__S_64_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
