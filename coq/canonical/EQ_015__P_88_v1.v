(* EQ-015/P.88.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Faraday's law of induction `EMF=-NΔΦ/Δt` and the motional-EMF special case `EMF=BLv` *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure` (finite-difference form)) *)
(* statement (Toledo canonical, latest): Faraday's law of induction EMF=-N\Delta\Phi/\Deltat and the motional-EMF special case EMF=BLv *)
...
Definition EQ_015__P_88_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
