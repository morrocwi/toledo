(* EQ-015/P.76.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Malus's law `I=I0 cos²θ` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Malus's law I=I0 cos^{2}\theta *)
...
Definition EQ_015__P_76_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
