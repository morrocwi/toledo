(* Keystone/P.01.v1 -- mapped_not_wrapped -> wrapped -- restates Qsq_nonneg (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_Hilbert.v) -- parents: Keystone *)
...
Definition Keystone__P_01_v1_restates_Qsq_nonneg_type := ltac:(let t := type of (@Qsq_nonneg) in exact t).
Lemma Keystone__P_01_v1_restates_Qsq_nonneg : Keystone__P_01_v1_restates_Qsq_nonneg_type.
Proof. exact (@Qsq_nonneg). Qed.

Print Assumptions Keystone__P_01_v1_restates_Qsq_nonneg.
