(* EQ-015/S.24.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Survival subspace S_A(R) *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): S_A(R) ⊆ span{φ_k} *)
...
Definition EQ_015__S_24_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
