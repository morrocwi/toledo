(* EQ-015/P.58.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Perfectly Matched Layer absorbing boundary *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: method used, genuine convergence achieved) *)
(* statement (Toledo canonical, latest): Perfectly Matched Layer absorbing boundary *)
...
Definition EQ_015__P_58_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
