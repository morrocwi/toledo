(* EQ-015/S.53.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.06.v1 *)
(* name: p*_A vector and threshold set C^alpha_A *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): p*_A = (p*_{A,g})_{g∈G}, C^α_A = {g : p*_{A,g} ≥ α} *)
...
Definition EQ_015__S_53_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
