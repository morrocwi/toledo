(* EQ-015/P.57.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Hyperboloidal-slicing method *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: method attempted (partially, per the negative-results log)) *)
(* statement (Toledo canonical, latest): Hyperboloidal-slicing method *)
...
Definition EQ_015__P_57_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
