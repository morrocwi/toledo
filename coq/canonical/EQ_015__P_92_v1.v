(* EQ-015/P.92.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Coulomb friction model `f=μN`, incline force components, Atwood machine acceleration, Pascal's principle hydraulic press *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Coulomb friction model f=\muN, incline force components, Atwood machine acceleration, Pascal's principle hydraulic press *)
...
Definition EQ_015__P_92_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
