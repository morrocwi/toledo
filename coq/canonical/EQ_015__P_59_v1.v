(* EQ-015/P.59.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Kepler's third law `T^2 = 4 pi^2 a^3/(G M)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Kepler's third law T^2 = 4 pi^2 a^3/(G M) *)
...
Definition EQ_015__P_59_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
