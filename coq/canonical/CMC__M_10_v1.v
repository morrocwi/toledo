(* CMC/M.10.v1 -- mapped_not_wrapped -> wrapped -- restates cattaneo_independent_target_has_closure (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_Independent_Definitions.v) -- parents: CMC *)
(* name: cattaneo_independent_target_has_closure (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact cattaneo_independent_target_has_closure.` against the already-verified import
...
Theorem CMC__M_10_v1_restates_cattaneo_independent_target_has_closure : CMC_TargetClass_independent cattaneo_independent_signature /\
  NonzeroClosure_independent cattaneo_independent_signature /\
  ~ CMC_Refuter_Burden_independent cattaneo_independent_signature.
Proof. exact cattaneo_independent_target_has_closure. Qed.

Print Assumptions CMC__M_10_v1_restates_cattaneo_independent_target_has_closure.
