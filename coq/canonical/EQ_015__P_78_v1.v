(* EQ-015/P.78.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Bohr model hydrogen energy levels `E_n=-13.6056931/n² eV` (full-precision CODATA 2018 Rydberg energy) *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Bohr model hydrogen energy levels E_n=-13.6056931/n^{2} eV (full-precision CODATA 2018 Rydberg energy) *)
...
Definition EQ_015__P_78_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
