(* EQ-015/P.112.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Schwarzschild static-observer gravitational time dilation `d_tau/dt = sqrt(1-r_s/r)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Schwarzschild static-observer gravitational time dilation d_tau/dt = sqrt(1-r_s/r) *)
...
Definition EQ_015__P_112_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
