(* EQ-015/W.30.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.05.v1 *)
(* name: Net effective claim Gamma^net *)
(* tier: Definition (definition/identity) *)
(* statement (Toledo canonical, latest): Gamma^net_(i,t) = Gamma_(i,t) - D^rent_(i,t) *)
...
Definition EQ_015__W_30_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
