(* CMC/P.08.v1 -- mapped_not_wrapped -> wrapped -- restates kinetic_transport_closure_witness (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_PhysicsClass_Instances.v) -- parents: CMC *)
(* name: kinetic_transport_closure_witness (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact kinetic_transport_closure_witness.` against the already-verified import
...
Theorem CMC__P_08_v1_restates_kinetic_transport_closure_witness : forall r : CertifiedPhysicalReadout,
    KineticTransportCertified r ->
    closure_form_present (certified_gamma r) KineticHiddenState.
Proof. exact kinetic_transport_closure_witness. Qed.

Print Assumptions CMC__P_08_v1_restates_kinetic_transport_closure_witness.
