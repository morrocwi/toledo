(* EQ-015/P.25.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: de Broglie's internal clock *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: interpretive anchor, `[Dr]`) *)
(* statement (Toledo canonical, latest): de Broglie's internal clock *)
...
Definition EQ_015__P_25_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
