(* EQ-015/P.69.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: 1D Ising real-space decimation RG, `K' = (1/2) ln cosh(2K)` (b=2 block-spin) *)
(* tier: untagged (textbook_system -- use_text: exact recursion iterated numerically, fixed points reported, `textbook_system`) *)
(* statement (Toledo canonical, latest): 1D Ising real-space decimation RG, K' = (1/2) ln cosh(2K) (b=2 block-spin) *)
...
Definition EQ_015__P_69_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
