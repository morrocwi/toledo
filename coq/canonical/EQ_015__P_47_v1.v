(* EQ-015/P.47.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Unruh temperature *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: cited, direction-check explicitly NOT performed) *)
(* statement (Toledo canonical, latest): Unruh temperature *)
...
Definition EQ_015__P_47_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
