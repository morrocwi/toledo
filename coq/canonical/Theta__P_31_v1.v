(* Theta/P.31.v1 -- mapped_not_wrapped -> wrapped -- restates red_cdiff (readout_genesis@082dde893b70c7500c13d463239909c99cf17f0a:coq/readout_genesis/formal/InfoThetaMinimalLiving_attempt.v) -- parents: Theta *)
(* name: red_cdiff (Lemma) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias.
   The type is obtained from Coq's own `type of red_cdiff` (see this
   ...
   entries). The proof is `exact red_cdiff.` against the
...
Definition Theta__P_31_v1_restates_red_cdiff_type := ltac:(let t := type of red_cdiff in exact t).
Lemma Theta__P_31_v1_restates_red_cdiff : Theta__P_31_v1_restates_red_cdiff_type.
Proof. exact red_cdiff. Qed.

Print Assumptions Theta__P_31_v1_restates_red_cdiff.
