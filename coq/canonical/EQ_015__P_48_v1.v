(* EQ-015/P.48.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Jacobson's thermodynamic derivation of Einstein's equation *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: imported argument/conclusion, `[AX/import]`; this project supplies the premises as theorems, not his conclusion) *)
(* statement (Toledo canonical, latest): Jacobson's thermodynamic derivation of Einstein's equation *)
...
Definition EQ_015__P_48_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
