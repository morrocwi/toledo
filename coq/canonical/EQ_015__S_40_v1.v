(* EQ-015/S.40.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.04.v1 *)
(* name: Non-collapse law 7: option count ≠ effective agency *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): option count ≠ effective agency *)
...
Definition EQ_015__S_40_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
