(* EQ-015/P.77.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Radioactive decay law `N=N0 e^{-λt}` and half-life `t½=ln2/λ` *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Radioactive decay law N=N0 e^{-\lambdat} and half-life t\tfrac{1}{2}=ln2/\lambda *)
...
Definition EQ_015__P_77_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
