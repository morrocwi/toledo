(* EQ-015/S.45.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.04.v1 *)
(* name: Non-collapse law 12: norm conformity ≠ absence of agency *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): norm conformity ≠ absence of agency *)
...
Definition EQ_015__S_45_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
