(* EQ-015/P.22.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Late-time tails, further numerical study *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: cited lineage for the numerical late-time-tail methodology) *)
(* statement (Toledo canonical, latest): Late-time tails, further numerical study *)
...
Definition EQ_015__P_22_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
