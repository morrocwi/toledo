(* EQ-015/W.56.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.19.v1 *)
(* name: Capability-conversion gap Delta g_(j,t) *)
(* tier: Definition (definition (Reversibility Principle itself [Open])) *)
(* statement (Toledo canonical, latest): Delta g_(j,t) = [ g~_(M,t) - g~_(Cj,t) ]_+ *)
...
Definition EQ_015__W_56_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
