(* EQ-015/P.03.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Special relativity / Lorentz invariance *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: boost formula imported; causal structure mechanized independently) *)
(* statement (Toledo canonical, latest): Special relativity / Lorentz invariance *)
...
Definition EQ_015__P_03_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
