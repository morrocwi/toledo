(* EQ-015/W.21.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.03.v1 *)
(* name: Growth decomposition of B^RB_t *)
(* tier: Definition (definition/identity) *)
(* statement (Toledo canonical, latest): B_dot^RB_t / B^RB_t = N_dot^RB_t / N^RB_t + q_dot^RB_t / q^RB_t *)
...
Definition EQ_015__W_21_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
