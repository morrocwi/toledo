(* EQ-015/P.84.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Carnot heat-engine efficiency `η=1-Tc/Th` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Carnot heat-engine efficiency \eta=1-Tc/Th *)
...
Definition EQ_015__P_84_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
