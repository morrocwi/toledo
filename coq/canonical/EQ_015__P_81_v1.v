(* EQ-015/P.81.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Fourier's law of heat conduction `Q/t=kAΔT/L` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Fourier's law of heat conduction Q/t=kA\DeltaT/L *)
...
Definition EQ_015__P_81_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
