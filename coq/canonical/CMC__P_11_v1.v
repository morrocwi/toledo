(* CMC/P.11.v1 -- mapped_not_wrapped -> wrapped -- restates flux_limited_diffusion_blocks_refuter (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_PhysicsClass_Instances.v) -- parents: CMC *)
(* name: flux_limited_diffusion_blocks_refuter (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact flux_limited_diffusion_blocks_refuter.` against the already-verified import
...
Theorem CMC__P_11_v1_restates_flux_limited_diffusion_blocks_refuter : forall r : CertifiedPhysicalReadout,
    FluxLimitedDiffusionCertified r ->
    CMC_Refuter_Burden (certified_gamma r) -> False.
Proof. exact flux_limited_diffusion_blocks_refuter. Qed.

Print Assumptions CMC__P_11_v1_restates_flux_limited_diffusion_blocks_refuter.
