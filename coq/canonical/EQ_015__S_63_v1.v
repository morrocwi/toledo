(* EQ-015/S.63.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.11.v1 *)
(* name: D5: feasible vs permitted *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): Feasible ≠ permitted *)
...
Definition EQ_015__S_63_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
