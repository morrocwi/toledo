(* EQ-015/P.74.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Young's double-slit interference fringe spacing `Δy=λL/d` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Young's double-slit interference fringe spacing \Deltay=\lambdaL/d *)
...
Definition EQ_015__P_74_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
