(* EQ-015/P.68.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: 2D square-lattice Ising critical temperature `T_c = 2J/(k_B ln(1+sqrt 2))` *)
(* tier: untagged (textbook_system -- use_text: closed-form constant evaluated numerically, `textbook_system`) *)
(* statement (Toledo canonical, latest): 2D square-lattice Ising critical temperature T_c = 2J/(k_B ln(1+sqrt 2)) *)
...
Definition EQ_015__P_68_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
