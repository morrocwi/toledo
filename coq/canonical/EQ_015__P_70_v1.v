(* EQ-015/P.70.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: SUVAT kinematics equations (`v=u+at`, `s=ut+½at²`, `v²=u²+2as`) *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): SUVAT kinematics equations (v=u+at, s=ut+\tfrac{1}{2}at^{2}, v^{2}=u^{2}+2as) *)
...
Definition EQ_015__P_70_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
