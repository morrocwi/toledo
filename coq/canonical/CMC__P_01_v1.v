(* CMC/P.01.v1 -- mapped_not_wrapped -> wrapped -- restates Retention_Lemma_certified (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_PhysicsClass_Instances.v) -- parents: CMC *)
(* name: Retention_Lemma_certified (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact Retention_Lemma_certified.` against the already-verified import
...
Theorem CMC__P_01_v1_restates_Retention_Lemma_certified : forall r : CertifiedPhysicalReadout,
    retained_diffusive (certified_gamma r) ->
    exists k : CarrierKind,
      RetentionCarrier k /\ CertifiedCarrierPresent r k.
Proof. exact Retention_Lemma_certified. Qed.

Print Assumptions CMC__P_01_v1_restates_Retention_Lemma_certified.
