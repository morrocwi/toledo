(* EQ-015/S.28.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.03.v1 *)
(* name: Collective potential V_G *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): V_G(M) := Σ_{i=1}^N w_i V_{A_i,R_i}(M),  w_i > 0 *)
...
Definition EQ_015__S_28_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
