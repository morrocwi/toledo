(* EQ-015/P.71.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Hooke's law `F=kx` and spring elastic PE `½kx²` *)
(* tier: untagged (textbook_closure -- use_text: numeric closures, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Hooke's law F=kx and spring elastic PE \tfrac{1}{2}kx^{2} *)
...
Definition EQ_015__P_71_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
