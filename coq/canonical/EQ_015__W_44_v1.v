(* EQ-015/W.44.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/W.10.v1 *)
(* name: Growth-rate decomposition of P^H_t (part 2) *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): ... + theta_S (S_dot^H_t/S^H_t) + theta_X (X_dot^H_t/X^H_t) - theta_D (D_dot^H_t/(1+D^H_t)) *)
...
Definition EQ_015__W_44_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
