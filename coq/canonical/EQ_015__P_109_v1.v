(* EQ-015/P.109.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Vis-viva equation `v^2 = GM(2/r - 1/a)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Vis-viva equation v^2 = GM(2/r - 1/a) *)
...
Definition EQ_015__P_109_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
