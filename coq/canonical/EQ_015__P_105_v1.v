(* EQ-015/P.105.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Planck's law of blackbody spectral radiance `B(lambda,T)` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Planck's law of blackbody spectral radiance B(lambda,T) *)
...
Definition EQ_015__P_105_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
