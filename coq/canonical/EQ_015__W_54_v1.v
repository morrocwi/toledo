(* EQ-015/W.54.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.01.v1, EQ-015/W.16.v1 *)
(* name: Elasticity sign constraints *)
(* tier: Definition (definition (elasticities/thresholds require per-study declaration)) *)
(* statement (Toledo canonical, latest): eta^HC_Gamma > 0,  eta^HC_(rH) < 0,  eta^HC_X < 0 *)
...
Definition EQ_015__W_54_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
