(* CMC/M.12.v1 -- mapped_not_wrapped -> wrapped -- restates class_witness_has_nonzero_closure (solver arc (private)@961151db33b0491cba8fabade69f594238d33f84:coq/solver-arc/formal/CMC_ModelClass_Witnesses.v) -- parents: CMC *)
(* name: class_witness_has_nonzero_closure (Theorem) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias -- the
   ...
   The proof is `exact class_witness_has_nonzero_closure.` against the already-verified import
...
Theorem CMC__M_12_v1_restates_class_witness_has_nonzero_closure : forall (c : WitnessModelClass) (g : TransportReadout),
    ClassWitness c g -> NonzeroClosure g.
Proof. exact class_witness_has_nonzero_closure. Qed.

Print Assumptions CMC__M_12_v1_restates_class_witness_has_nonzero_closure.
