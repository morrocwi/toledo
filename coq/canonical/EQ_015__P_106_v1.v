(* EQ-015/P.106.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Rectangular waveguide TE_mn cutoff frequency *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Rectangular waveguide TE_mn cutoff frequency *)
...
Definition EQ_015__P_106_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
