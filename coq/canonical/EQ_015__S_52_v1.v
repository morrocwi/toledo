(* EQ-015/S.52.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015/M.03.v1, EQ-015/S.06.v1 *)
(* name: [restatement of p*_{A,g}] *)
(* tier: Definition (definition) *)
(* statement (Toledo canonical, latest): p*_{A,g}(h,z;T,B,P) := max_{π∈Πwit_A(g;h,z,T,B)} Pr^π_P(Rg ∩ Dg ∩ Xg ∩ Fg), with p*_{A,g} := 0 when the set is empty *)
...
Definition EQ_015__S_52_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
