(* EQ-015/P.75.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Diffraction grating equation `d sinθ = mλ` *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Diffraction grating equation d sin\theta = m\lambda *)
...
Definition EQ_015__P_75_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
