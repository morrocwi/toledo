(* Theta/P.29.v1 -- mapped_not_wrapped -> wrapped -- restates red_rdiff (readout_genesis@082dde893b70c7500c13d463239909c99cf17f0a:coq/readout_genesis/formal/InfoThetaMinimalLiving_attempt.v) -- parents: Theta *)
(* name: red_rdiff (Lemma) *)
...
(* Toledo v1.5 lane B (DEBT #45): restatement, not a bare alias.
   The type is obtained from Coq's own `type of red_rdiff` (see this
   ...
   entries). The proof is `exact red_rdiff.` against the
...
Definition Theta__P_29_v1_restates_red_rdiff_type := ltac:(let t := type of red_rdiff in exact t).
Lemma Theta__P_29_v1_restates_red_rdiff : Theta__P_29_v1_restates_red_rdiff_type.
Proof. exact red_rdiff. Qed.

Print Assumptions Theta__P_29_v1_restates_red_rdiff.
