(* EQ-015/P.103.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Bose-Einstein distribution *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Bose-Einstein distribution *)
...
Definition EQ_015__P_103_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
