(* EQ-015/P.45.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Clausius relation `δQ=TδS` *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: mechanized as an iff, form of the relation only; T imported as a lens) *)
(* statement (Toledo canonical, latest): Clausius relation \deltaQ=T\deltaS *)
...
Definition EQ_015__P_45_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
