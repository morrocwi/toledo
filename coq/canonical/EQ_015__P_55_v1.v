(* EQ-015/P.55.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Quasinormal-mode analytic representation *)
(* tier: untagged (<no tier tag in registry 'use' text> -- use_text: literature target value, comparison only) *)
(* statement (Toledo canonical, latest): Quasinormal-mode analytic representation *)
...
Definition EQ_015__P_55_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
