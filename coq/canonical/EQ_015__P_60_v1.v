(* EQ-015/P.60.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Bernoulli's equation (steady incompressible streamline energy balance) *)
(* tier: untagged (textbook_closure -- use_text: numeric closure solved for `p2`, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Bernoulli's equation (steady incompressible streamline energy balance) *)
...
Definition EQ_015__P_60_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
