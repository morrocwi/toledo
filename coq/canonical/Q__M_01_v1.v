(* Q/M.01.v1 -- mapped_not_wrapped -> wrapped -- restates Qsq_nonneg3 (information-discrete-math@147fc92671f35eb102405fec913eb361dc41f966:formal/IDM_FiniteWitnesses3.v) -- parents: Q *)
(* name: Qsq_nonneg3 (Lemma) *)
...
(* Toledo v1.7 cheap-win lane 1 (IDM wrap): restatement, not a bare
   alias. The type is obtained from Coq's own `type of Qsq_nonneg3`
   ...
   is `exact Qsq_nonneg3.` against the already-verified IDM mirror
   import below -- no new proof technique, no new claim. *)

From IDM.formal Require Import IDM_FiniteWitnesses3.

Definition Q__M_01_v1_restates_Qsq_nonneg3_type := ltac:(let t := type of (@Qsq_nonneg3) in exact t).
Lemma Q__M_01_v1_restates_Qsq_nonneg3 : Q__M_01_v1_restates_Qsq_nonneg3_type.
Proof. exact (@Qsq_nonneg3). Qed.

Print Assumptions Q__M_01_v1_restates_Qsq_nonneg3.
