(* EQ-015/P.24.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Raychaudhuri equation *)
(* tier: Open (Open -- use_text: named as the target continuum engine only; this file mechanizes the STATIC half (exact cut bookkeeping and its price), explicitly not the rate/focusing law, which stays `Open`) *)
(* statement (Toledo canonical, latest): Raychaudhuri equation *)
...
Definition EQ_015__P_24_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
