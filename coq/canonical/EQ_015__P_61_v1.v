(* EQ-015/P.61.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Continuity equation `A1 v1 = A2 v2` (incompressible 1D duct form) *)
(* tier: untagged (textbook_closure -- use_text: numeric closure, `textbook_closure`) *)
(* statement (Toledo canonical, latest): Continuity equation A1 v1 = A2 v2 (incompressible 1D duct form) *)
...
Definition EQ_015__P_61_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
