(* EQ-015/P.98.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Boltzmann distribution `p ∝ exp(-E/k_B T)` *)
(* tier: untagged (textbook_system -- use_text: the stationary-distribution closed form this solver evaluates numerically, `textbook_system`) *)
(* statement (Toledo canonical, latest): Boltzmann distribution p \propto exp(-E/k_B T) *)
...
Definition EQ_015__P_98_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
