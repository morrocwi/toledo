(* EQ-015/P.62.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: 2D truss method of joints (joint-equilibrium linear system, `m+r=2j` determinacy count) *)
(* tier: untagged (textbook_system -- use_text: assembled + solved numerically, `textbook_system`) *)
(* statement (Toledo canonical, latest): 2D truss method of joints (joint-equilibrium linear system, m+r=2j determinacy count) *)
...
Definition EQ_015__P_62_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
