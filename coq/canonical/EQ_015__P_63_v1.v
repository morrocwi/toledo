(* EQ-015/P.63.v1 — wrapped_related — wraps evidence/DRL_Forced_Master.v.discrete_Lagrange_d_Alembert_forced_master_theorem — parents: EQ-015 *)
(* name: Euler–Bernoulli beam theory *)
(* tier: untagged (textbook_system -- use_text: governing model for the beam element, numeric FEM solve, `textbook_system`) *)
(* statement (Toledo canonical, latest): Euler–Bernoulli beam theory *)
...
Definition EQ_015__P_63_v1_reads := discrete_Lagrange_d_Alembert_forced_master_theorem.
